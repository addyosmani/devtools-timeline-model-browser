/**
 * @name timeline-model-treeview.js
 * @description Necessary fork of the timeline-model-treeview code from devtools-timeline-model
 * as the npm package appears to maintain a different version of the source we require.
 */
